...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private static final int[] ATTRS = new int[] { 23, R.color.theme_blue };
	// @formatter:on
	...
	private int indicatorColor = 0xFF3366cc;
	private int underlineColor = 0xFFaaaaaa;
	private int dividerColor = 0x1A333333;
	...
	private int tabTextColor = 0xFF9e9e9e;
