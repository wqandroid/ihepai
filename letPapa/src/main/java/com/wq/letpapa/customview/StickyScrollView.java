...
//		checkKeyBoard(b);
	...
	private void checkKeyBoard(int b) {
		if (!mHasInit) {
			mHasInit = true;
			mHeight = b;
			if (mListener != null) {
	...
	public void setonScrollChanged(ScrollChanged changed) {
...
//		Trace.i("l"+l+"t"+t+"oldl"+oldl+"oldt"+oldt);
