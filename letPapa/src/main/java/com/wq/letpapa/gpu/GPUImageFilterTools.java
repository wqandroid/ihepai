...
import com.wq.letpapa.gpu.filter.IFBrannanFilter;
import com.wq.letpapa.gpu.filter.IFEarlybirdFilter;
import com.wq.letpapa.gpu.filter.IFHefeFilter;
import com.wq.letpapa.gpu.filter.IFInkwellFilter;
import com.wq.letpapa.gpu.filter.IFNashvilleFilter;
import com.wq.letpapa.gpu.filter.IFSutroFilter;
import com.wq.letpapa.gpu.filter.IFToasterFilter;
import com.wq.letpapa.gpu.filter.IFWaldenFilter;
import com.wq.letpapa.gpu.filter.IFXprollFilter;

public class GPUImageFilterTools {
	static FilterList filters = new FilterList();
	
	static {
		filters.addFilter("nomore", FilterType.NORMORE);
